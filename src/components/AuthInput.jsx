...
const AuthInput = ({ what, isPasswordField }) => {
    ...
    return (
        <div className='flex flex-col items-start justify-start gap-1 w-full'>
            ...
            <div className="flex items-center justify-center w-full gap-3 md:w-96 rounded-md px-4 py-1 bg-gray-200">
                ...
                <input type="text" placeholder={"Enter your " + what.toLowerCase() + " here"} className="px-4 py-1 flex-1 text-lg outline-none bg-transparent text-black" value={value} onChange={(e) => setValue(e.target.value)} />


                {isPasswordField && <div className='cursor-pointer' >
