...
const ProjectCard = ({ proj, index }) => {
    ...
    return (
        <motion.div key={index} className='w-full cursor-pointer md:w-[450px] h-[375px] bg-[#09094d] rounded-xl p-4 flex flex-col items-center justify-center gap-4 text-[#808198]'>
