        ...
        <div className='text-[#868CA0] w-full py-6'>
            <div className='w-full flex flex-col items-center justify-center py-8 '>
                ...
                <div className="px-8 py-4 w-full md:w-auto bg-[#2f3181] rounded-lg shadow-md flex flex-col items-center justify-center gap-5">
                    ...
                    <motion.div whileTap={{ scale: .8 }} className="flex items-center justify-center gap-5 bg-[#1D1D57] backdrop-blur-md w-full py-3 rounded-xl hover:bg-[#0e0e68] cursor-pointer">
